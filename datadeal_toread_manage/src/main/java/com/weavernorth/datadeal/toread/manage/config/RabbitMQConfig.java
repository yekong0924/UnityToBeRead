...
public class RabbitMQConfig
{
    ...
    public static final String QUEUE_RECEIVE_TODO = "mq_queue_direct_readdata";//请求队列名称



    // 回调队列交换机
    public static final String EXECHANGE_RESPONSE_TODO = "mq_exchange_direct";//交换机


    // 异常数据处理队列交换机
    public static final String EXECHANGE_EXCEPTION = "mq_exchange_direct";//交换机

    // 回调队列名称
    public static final String QUEUE_RESPONSE_TODO = "ur_reponse_todo_map";//反馈队列名称

    // 异常数据处理队列名称
    public static final String QUEUE_EXCEPTION = "ur_exception";//异常队列名称


    // 回调队列路由关键字
    public static final String ROUTING_RESPONSE_TODO = "ur_reponse_todo_map_key";//


    // 异常数据处理队列路由关键字
    public static final String ROUTING_EXCEPTION = "ur_exception_key";//
   /*
    ...
    */
    ...
    // 异常处理  交换机
    @Bean
    public DirectExchange defaultExchange_exception()
    {
        //默认是交换机持久化
        return new DirectExchange(EXECHANGE_EXCEPTION);
    }

//    @Bean
//    public DirectExchange defaultExchange_reponse()
//    {
//        //默认是交换机持久化
//        return new DirectExchange(EXECHANGE_RESPONSE);
//    }

    // 回调  交换机
    @Bean
    public DirectExchange defaultExchange_reponse_todo()
    {
        //默认是交换机持久化
        return new DirectExchange(EXECHANGE_RESPONSE_TODO);
    }
...
//    @Bean
//    public Queue queue_response()
//    {
//        //默认也是队列持久化  durable-true 队列持久化
//        return new Queue(QUEUE_RESPONSE, true); //队列持久
//    }
    // 回调  队列
    @Bean
    public Queue queue_response_todo()
    {
        //默认也是队列持久化  durable-true 队列持久化
        return new Queue(QUEUE_RESPONSE_TODO, true); //队列持久
    }
    // 异常处理队列和异常处理交换机绑定
    @Bean
    public Binding binding_queue_exception()
    {
        return BindingBuilder.bind(queue_exception()).to(defaultExchange_exception()).with(ROUTING_EXCEPTION);
    }

//    @Bean
//    public Binding binding_queue_response()
//    {
//        return BindingBuilder.bind(queue_response()).to(defaultExchange_reponse()).with(ROUTING_RESPONSE);
//    }

    // 回调队列和回调交换机绑定
    @Bean
    public Binding binding_queue_response_todo()
    {
        return BindingBuilder.bind(queue_response_todo()).to(defaultExchange_reponse_todo()).with(ROUTING_RESPONSE_TODO);
    }
